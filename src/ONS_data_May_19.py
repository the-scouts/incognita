    ...
    def __init__(self, ons_pd_csv_path, load_data=True):
        ...
        self.BOUNDARIES = {
            "lad": {
                ...
                "name": "oslaua",
                "codes": {"path": "LA_UA names and codes UK as at 12_19.csv", "key": "LAD19CD", "key_type": "category", "name": "LAD19NM"},
            ...
            "osward": {
                "name": "osward",
                "codes": {"path": "Ward names and codes UK as at 05_19_NSPD.csv", "key": "WD19CD", "key_type": "category", "name": "WD19NM"},
                "boundary": {"shapefiles": WARD_SHAPEFILE, "key": 'wd18cd', "name": 'wd18nm',},
                "age_profile": {"path": None, "key": None},
            },
            "pcon": {
                "name": "pcon",
                "codes": {"path": "Westminster Parliamentary Constituency names and codes UK as at 12_14.csv", "key": "PCON14CD", "key_type": "category", "name": "PCON14NM"},
                "boundary": {"shapefiles": PCON_SHAPEFILE, "key": 'pcon17cd', "name": "pcon17nm",},
                "age_profile": {"path": "pcon_by_age.csv", "key": "PCON11CD"},
            },
            "lsoa": {
                "name": "lsoa11",
                "codes": {"path": "LSOA (2011) names and codes UK as at 12_12.csv", "key": "LSOA11CD", "key_type": "category", "name": "LSOA11NM"},
                "boundary": {"shapefiles": LSOA_SHAPEFILE, "key": 'lsoa11cd', "name": 'lsoa11nm',},
                "age_profile": {"path": None, "key": None},
            },
            "msoa": {
                "name": "msoa",
                "codes": {"path": "MSOA (2011) names and codes UK as at 12_12.csv", "key": "MSOA11CD", "key_type": "category","name": "MSOA11NM"},
                "boundary": {"shapefiles": MSOA_SHAPEFILE, "key": 'msoa11cd', "name": None,},
                "age_profile": {"path": None, "key": None},
            },
            "iz": {
                "name": "iz",
                "codes": {"path": None, "key": None, "key_type": "category", "name": None},
