    ...
    BOUNDARIES={
        "lad": Boundary(
            ...
            shapefile=BoundaryShapeFile(
                path=config.SETTINGS.folders.boundaries
                / "Local_Authority_Districts__December_2019__Boundaries_UK_BUC"
                / "Local_Authority_Districts__December_2019__Boundaries_UK_BUC.shp",
                key="lad19cd",
                name="lad19nm",
            ),
        ...
        "cty": Boundary(
            ...
            shapefile=BoundaryShapeFile(
                path=config.SETTINGS.folders.boundaries
                / "Counties_and_Unitary_Authorities_December_2017_Generalised_Clipped_Boundaries_in_UK"
                / "Counties_and_Unitary_Authorities_December_2017_Generalised_Clipped_Boundaries_in_UK.shp",
                key="ctyua17cd",
                name="ctyua17nm",
            ),
        ),
        ...
        "pcon": Boundary(
            ...
            shapefile=BoundaryShapeFile(
                path=config.SETTINGS.folders.boundaries
                / "Westminster_PCON_Dec_2017_Generalised_Clipped_UK"
                / "Westminster_Parliamentary_Constituencies_December_2017_Generalised_Clipped_Boundaries_in_the_UK.shp",
                key="pcon17cd",
                name="pcon17nm",
            ),
            age_profile=BoundaryAgeProfile(
        ...
        "lsoa": Boundary(
            ...
            shapefile=BoundaryShapeFile(
                path=config.SETTINGS.folders.boundaries
                / "Lower_Layer_Super_Output_Areas_December_2011_Boundaries_EW_BSC"
                / "Lower_Layer_Super_Output_Areas_December_2011_Boundaries_EW_BSC.shp",
                key="LSOA11CD",
                name="LSOA11NM",
            ),
        ),
        "msoa": Boundary(
            ...
            shapefile=BoundaryShapeFile(
                path=config.SETTINGS.folders.boundaries
                / "Middle_Layer_Super_Output_Areas_December_2011_Full_Clipped_Boundaries_in_England_and_Wales"
                / "Middle_Layer_Super_Output_Areas_December_2011_Full_Clipped_Boundaries_in_England_and_Wales.shp",
                key="msoa11cd",
                name=None,
            ),
        ),
